...
const COMPLETED_ORDER_STATUSES: OrderStatus[] = [OrderStatus.SHIPPED, OrderStatus.DELIVERED];

export async function getCompletedOrders(paginator: Paginator, filter: CompletedOrderFilter): Promise<ApiResponse> {
  try {
