                ...
                <TableRow key={item.id}>
                  <TableCell>
                    {item.primaryImageUrl ? (
                      <div className="relative h-30 w-30 rounded-md overflow-hidden border border-border">
                        <Image
                      ...
                      <div className="h-12 w-12 rounded-md border border-border bg-muted flex items-center justify-center">
