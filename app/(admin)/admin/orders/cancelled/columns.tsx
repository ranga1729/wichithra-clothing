...
import { CancelledOrderSchema } from "@/schemas/admin-schemas"
...
export const getColumns = ({ onCancel, onMove, onView, paginator }: ColumnProps): ColumnDef<CancelledOrderSchema>[] => [
  {
    id: "index",
    header: "No.",
    cell: ({ row }) => {
