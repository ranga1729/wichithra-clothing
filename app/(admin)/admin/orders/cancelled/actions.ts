...
const CANCELLED_ORDER_STATUSES: OrderStatus[] = [OrderStatus.CANCELLED, OrderStatus.RETURNED, OrderStatus.REFUNDED];

export async function getCancelledOrders(paginator: Paginator, filter: CancelledOrderFilter): Promise<ApiResponse> {
  try {
