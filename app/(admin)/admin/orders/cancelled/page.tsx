...
import { CancelledOrderFilter } from "@/types/filter-types"
...
export default function CancelledOrdersPage() {
  ...
  const [filter, setFilter] = useState<CancelledOrderFilter>(initialFilter)
  ...
  const { data, isPending, error, isError } = useQuery({
    queryKey: ["cancelled-orders", "list",
      {
    ...
    queryFn: async () => {
      const response = await getCancelledOrders(paginator, debouncedFilter)
      if (!response.success) {
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  ...
                  className="justify-start px-2.5 font-normal bg-transparent border-border"
                >
